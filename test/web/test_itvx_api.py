    ...
    def get_playlist_live(self, channel):
        ...
        resp = requests.post(
                ...
                headers={
                    ...
                    # The user agent doesn't seem to matter much, except that
                    # there must be a dot in the name and there must be something between bracket
                    'User-Agent': 'X-player.1 (linux)', # 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:104.0) Gecko/20100101 Firefox/104.0 ',
                    'Origin':           'https://www.itv.com',
                },
